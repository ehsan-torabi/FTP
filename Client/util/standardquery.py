from utils.command_to_code import commands_dict
import json

class StandardQuery:
    def __init__(self,auth_token:str,command:str|int,current_dir:str=None,command_args:list[str]=None,data:any=None):
    ...
    def serialize(self):
        ...
        try:
            if not self.command.isnumeric():
                self.command = commands_dict[self.command]
